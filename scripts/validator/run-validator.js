...
const { ERC20ABI } = require("../../artifacts/contracts/ERC20Token.sol/ERC20Token.json");
const { WETHABI } = require("../../artifacts/contracts/ETHWrapper.sol/ETHWrapperContract.json");
const { TLedgerABI } = require("../../artifacts/contracts/TokenLedger.sol/TokenLedger.json");
